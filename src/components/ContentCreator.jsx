...
const ContentCreator = () => {
  return (
    <section id="creator" className="bg-[#0a0a0a] pt-16 md:pt-24 pb-20 md:pb-32 px-4 sm:px-6 md:px-12 w-full relative overflow-hidden font-sans bg-[linear-gradient(to_right,#8080800a_1px,transparent_1px),linear-gradient(to_bottom,#8080800a_1px,transparent_1px)] bg-[size:80px_80px]">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        {/* Instagram CTA */}
        <div data-aos="fade-up" data-aos-delay="400" className="mt-12 md:mt-16 flex justify-center">
          <a
            href={socialLinks.instagram}
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center justify-center gap-3 px-6 py-3.5 sm:px-8 sm:py-4 rounded-full bg-[#ff2a2a] text-white font-bold text-sm sm:text-lg hover:bg-red-600 hover:shadow-[0_0_30px_rgba(255,42,42,0.4)] transition-all duration-500 group max-w-full text-center"
          >
