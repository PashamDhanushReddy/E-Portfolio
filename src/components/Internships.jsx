...
const InternshipCard = ({ intern, index }) => (
  ...
  >
    <div>
      ...
      <p className="text-red-200 text-xs sm:text-sm font-black tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
      <div className="mb-6">
...
const Internships = () => {
  return (
    <section className="bg-[#ff2a2a] pt-16 md:pt-24 pb-24 md:pb-32 px-4 sm:px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        <div data-aos="fade-up" className="mb-12 md:mb-20 text-center">
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-black text-black mb-4 tracking-tight uppercase">
            Work Experience
          </h2>
